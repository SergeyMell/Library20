class CategoriesController < ApplicationController
  ...
  def reviews_by_chapter
    ...
    render_options(chapter.reviews.try(:order, :title), '#review_selector')
  rescue => e
  ...
  def sections_by_review
    ...
    render_options(review.sections.try(:order, :title), '#section_selector')
  rescue => e
  ...
  def subsections_by_section
    ...
    render_options(section.subsections.try(:order, :title), '#subsection_selector')
  rescue => e
